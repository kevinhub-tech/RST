...
<body>
	...
	<div class="container-fluid bg-1 text-center">
		<h3 class="margin">Sign into your account</h3>
			...
			<div class="col-md-4">
				...
				<form action="${post_url}" method="post">
					...
					<div class="form-group">
						...
						<label for="username" style="color:black;">User Name:</label> <input type="text"
					...
					<input type="submit" name="Login" value="Login"
						class="btn btn-primary" style="background-color:black;"></input>
				</form>
			</div>
